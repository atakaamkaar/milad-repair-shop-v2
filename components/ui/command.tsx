...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-foreground [&_**:[[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 **:[[cmdk-group-heading]]:px-2 [&_**:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:font-medium",
        className
      )}
      {...props}
    />
